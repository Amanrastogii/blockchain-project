...
import { idlFactory } from './aman_frontend.did.js';
export { idlFactory } from './aman_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AMAN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aman_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aman_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aman_frontend.did.js")._SERVICE>}
 */
export const aman_frontend = createActor(canisterId);
