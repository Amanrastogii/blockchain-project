...
import { idlFactory } from './aman_backend.did.js';
export { idlFactory } from './aman_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AMAN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aman_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aman_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aman_backend.did.js")._SERVICE>}
 */
export const aman_backend = createActor(canisterId);
